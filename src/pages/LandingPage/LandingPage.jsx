...
import {TwitterIcon, FacebookIcon, LucideLinkedin} from "lucide-react"
const LandingPage = () => {
  return (
    <>
              {/* Hero section */}
              ...
              {/* Steps section to generate invoice */}
            ...
            <footer className="py-5 bg-dark text-white-50">
                <div className="container text-center">
                    ...
                    <p className="mt-2">
                        ...
                        <a href="#" className="text-white-50 me-2"><TwitterIcon/></a>
                        <a href="#" className="text-white-50 me-2"><FacebookIcon/></a>
                        <a href="#" className="text-white-50"><LucideLinkedin/></a>
                    </p>
                </div>
            </footer>
    </>
