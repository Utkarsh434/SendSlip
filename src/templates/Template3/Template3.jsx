                ...
                <table className="table table-bordered mb-0">
                    ...
                    {data.items.map((item, index) => (
                        <tr key={index}>
                            ...
                            <td className="p-3 text-center">{data.currencySymbol}{Number(item.amount).toFixed(2)}</td>
                            <td className="p-3 text-end">{data.currencySymbol}{(Number(item.qty) * Number(item.amount)).toFixed(2)}</td>
                        </tr>
                    ))}
                    </tbody>
                </table>
